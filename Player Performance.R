...
## EXPORTING TABLE FOR V LOOKUP
write.table(Merge, "C:\\Users\\Esha\\Desktop\\DATA SCIENCE PROJECT FINAL\\Final Data Required\\Merge.csv", sep = ",")
write.table(MergeFinal, "C:\\Users\\Esha\\Desktop\\DATA SCIENCE PROJECT FINAL\\Final Data Required\\Merge_Final.csv", sep = ",")
...
write.csv(a, "C:\\Users\\Esha\\Desktop\\Data Science - FINAL\\FINAL\\PlayerUtility.csv", sep = ",")
...
write.csv(b, "C:\\Users\\Esha\\Desktop\\Data Science - FINAL\\FINAL\\PlayerBowlUtility.csv", sep = ",")
...
# EXPORTING THE FILES
write.table(MergeDataFinal, file = "C:\\Users\\Esha\\Desktop\\DATA SCIENCE PROJECT FINAL\\FINALFILEFINAL.csv", sep = ",", col.names = TRUE)
write.table(r_a, "C:\\Users\\Esha\\Desktop\\DATA SCIENCE PROJECT FINAL\\RanksOfBatsman.csv", sep = ",", col.names = TRUE)
write.table(r_b, "C:\\Users\\Esha\\Desktop\\DATA SCIENCE PROJECT FINAL\\RanksOfBowler.csv", sep = ",", col.names = TRUE)
...
View(m)
write.table(m, "C:\\Users\\Esha\\Desktop\\Data Science - FINAL\\FINAL\\PlayerofMatch2.csv", sep = ",", col.names = TRUE)
